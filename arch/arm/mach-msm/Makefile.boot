...
# MSM8226
   zreladdr-$(CONFIG_ARCH_MSM8226)	:= 0x00008000
	dtb-$(CONFIG_MACH_SONY_EAGLE)   += msm8226-v1-yukon_eagle-mtp.dtb
	...
	dtb-$(CONFIG_MACH_SONY_FLAMINGO)+= msm8226-yukon_flamingo-8226ss_dp.dtb
	dtb-$(CONFIG_MACH_SONY_FLAMINGO)+= msm8226-yukon_flamingo-8226ds_dp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8926_seagull-1080p-cdp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8926_seagull-1080p-mtp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8926_seagull-720p-cdp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8926_seagull-720p-mtp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8926_seagull-qrd.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8926_seagull-qrd-skug.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8926_seagull-qrd-skug-pvt.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-fluid.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-sim.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v1-cdp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v1-mtp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v1-qrd-dvt.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v1-qrd-evt.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v1-qrd-skuf.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v1-qrd-skuf-pvt.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v2-1080p-cdp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v2-1080p-mtp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v2-720p-cdp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v2-720p-mtp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v2-qrd-dvt.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v2-qrd-evt.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v2-qrd-pvt.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v2-qrd-skuf.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= msm8226_seagull-v2-qrd-skuf-pvt.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= apq8026_seagull-v1-cdp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= apq8026_seagull-v1-mtp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= apq8026_seagull-v1-xpm.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= apq8026_seagull-v2-1080p-cdp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= apq8026_seagull-v2-1080p-mtp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= apq8026_seagull-v2-720p-cdp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= apq8026_seagull-v2-720p-mtp.dtb
	dtb-$(CONFIG_MACH_SONY_SEAGULL)	+= apq8026_seagull-v2-xpm.dtb
